...
export default function NoteEditor() {
  ...
  const saveColor =
    saveStatus === "error"
      ? colors.danger // destructive — system red (APP_AESTHETIC §2)
      : showSaving
        ? colors.icon // in progress (prolonged only)
        : colors.presence; // saved — live status colour
  const saveLabel =
    saveStatus === "error" ? "Couldn't save" : showSaving ? "Saving…" : "Saved";
      ...
      <ScreenContainer>
        <View style={styles.header}>
          ...
          >
            ...
            <Text variant="body" className="ml-0.5">
              Notes
            </Text>
          </TouchableOpacity>
        </View>
      ...
      >
        ...
        <View style={styles.contentArea}>
          <NoteNotices
            ...
            requestFrom={
              canEdit && pendingRequest ? pendingRequest.displayName : null
            }
          ...
          >
            ...
            {!isViewer && (
              <View style={styles.metaRow}>
                <View
                  style={[styles.savedDot, { backgroundColor: saveColor }]}
                />
            ...
            {Platform.OS === "web" && MarkdownEditorWeb ? (
              ...
              <MarkdownEditorNative
                ...
                style={{
                  height: Math.max(webViewHeight, editorMinHeight),
        ...
        {canEdit && <MarkdownToolbar onAction={handleToolbarAction} />}
        ...
        {!canEdit && (
          <TouchableOpacity
            onPress={() => {
              ...
              if (isLocked)
                requestEdit(); // someone holds it → ask for the pen
          ...
          >
            <View
              style={[
                styles.presenceDot,
                !isLocked && styles.presenceDotViewing,
              ]}
            />
